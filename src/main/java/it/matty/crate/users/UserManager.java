...
public class UserManager implements IUserManager {
    @Getter
    private final int CRATE_PER_DAY = CratePlugin.getPlugin().getConfig().getInt("settings.crate-per-day");
    @Getter
    private final int CRATE_DELAY = CratePlugin.getPlugin().getConfig().getInt("settings.crate-delay");
    @Getter
    Set<CrateUser> users = new HashSet<>();
